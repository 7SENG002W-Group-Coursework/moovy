...
class DateFormatterUtils {
    ...
    static let moovyDateFormat: DateFormatter = {
        let dateFormatter = DateFormatter()
    ...
    static func formattedDateWithMonthAbbreviationAndTime(from timestamp: TimeInterval) -> String {
           let dateFormatter = DateFormatter()
           dateFormatter.dateFormat = "dd-MMM 'at' h:mm a"
           return dateFormatter.string(from: Date(timeIntervalSince1970: timestamp))
       }
